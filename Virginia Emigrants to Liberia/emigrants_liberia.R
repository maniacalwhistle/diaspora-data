...
# - page=Resources
# - section=Search%20Emigrants
# - result=yes

# Note: can't get table from raw url to work so saved page source as
# local html file for now; need to work on this
# url <- "http://www.vcdh.virginia.edu/liberia/index.php?page=Resources&section=Search%20Emigrants&result=yes"
url <- "/Users/Sherlock/Desktop/Black Diaspora Data/Virginia Emigrants to Liberia/emigrants.html"
